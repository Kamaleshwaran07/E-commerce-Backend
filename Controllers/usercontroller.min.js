...
const userController = {
    ...
    editRoleDetails:async(req,res)=>{
        ...
        try {
            ...
            const userUpdate = await User.findOneAndUpdate(userId, {role:role})
            await userUpdate.save()
    ...
    editUserDetails:async(req,res)=>{
        ...
        try {
            const userId = req.userId
            const user = await User.findByIdAndUpdate(userId, {name:name, email:email, password:password, profilePicture:profilePicture})
            await user.save()
